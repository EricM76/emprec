        ...
        pageLoader: function () {
            ...
            if (!$body.hasClass('no-page-loader')) {
                var pageInAnimation = $body.attr('data-animation-in') || "fadeIn",
                    ...
                    pageLoaderIcon = $body.attr('data-icon') || 1,
                ...
                switch (Number(pageLoaderIcon)) {
                    ...
                    case 8:
                        ...
                        loadingInnerHTML = '<div><img src="images/logo.png" alt="EMPREC"><div></div><div></div></div>';
        ...
        contactForm: function () {
            ...
            if ($contactForm.length > 0) {
                ...
                $contactForm.each(function () {
                    var elem = $(this),
                        elemSuccessMessage = elem.attr('data-success-message') || "MENSAJE ENVIADO <strong>OK</strong>";
